...
namespace CRUDAppWebAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1", new OpenApiInfo
                {
                    Version = "V1",
                    Title = "Products API",
                    Description = "Products API with CRUD operations, login and roles"
                });
                ...
                c.IncludeXmlComments(@"C:\_MyProjects\Web API\CRUDAppWebAPI\WebAPI.xml");
            }
                );
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "Products API V!");
            });
